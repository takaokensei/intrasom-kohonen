...
import type { UMatrix3DNeuron } from '../components/UMatrix3D';

describe('UMatrix3D data transformation', () => {
  const dummyNeurons: UMatrix3DNeuron[] = [
    {
      id: 1,
      row: 0,
      col: 0,
  ...
  it('validates mock neurons data structure for 3D mesh initialization', () => {
